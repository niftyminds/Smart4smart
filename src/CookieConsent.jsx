    ...
    <>
      ...
      {status === null && !showModal && (
        ...
        <div className="fixed bottom-2 left-2 right-2 sm:bottom-2 sm:left-1 sm:right-1 md:bottom-10 md:left-10 md:right-10 z-50 sm:p-3">
          <div className={`${slideClass} max-w-5xl mx-auto bg-slate-100 rounded-2xl shadow-[0_4px_40px_rgba(0,0,0,0.10)] sm:shadow-[0_20px_60px_-5px_rgba(0,0,0,0.12)] border border-slate-200 px-5 pt-5 pb-6 sm:px-8 sm:py-6 max-h-[calc(100vh-4rem)] overflow-y-auto`}>
